...
@section('css')
    <link href="{{ voyager_asset('css/applozic/app/fullview/applozic.combined.min.css') }}" rel="stylesheet">
    <link href="{{ voyager_asset('css/applozic/autosuggest/css/jquery.atwho.min.css') }}" rel="stylesheet">
    <link href="{{ voyager_asset('css/applozic/app/fullview/applozic.fullview.css') }}" rel="stylesheet">
    <link rel="stylesheet" href="{{ voyager_asset('css/applozic/app/fullview/applozic.plugin.css') }}">
...
@section('content')
   ...
   <div class="page-content container-fluid">
    <div class="form-group">
        ...
        <textarea name="text" id="text" class="form-control" cols="50" rows="3"></textarea>

        <a href="javascript:void(0);" class="btn btn-xs btn-info" onclick="sendgroupmessage();">Send Message</a>

        @foreach($cities as $city)
            <input type="hidden" name="{{$city->city}}" id="{{$city->city}}" value="{{$arrayCities[$city->city]}}">
        @endforeach
    </div>
                ...
                <div class="mck-box-top mck-row mck-wt-user-icon">
                    ...
                    <div class="blk-lg-2 move-right mck-menu-item mck-text-right">
                        <div class="mck-dropdown-toggle" data-toggle="mckdropdown"
                            aria-expanded="true">
                            <img src="{{ voyager_asset('images/applozic/icon-menu.png') }}" class="mck-menu-icon"
                                alt="Menu">
                        </div>
                ...
                <div class="mck-panel-body">
                    <div id="mck-contact-cell" class="mck-panel-cell">
                        ...
                        <div id="mck-contact-loading" class="mck-loading">
                            <img src="{{ voyager_asset('images/applozic/ring.gif')}}">
                        </div>
                            ...
                            <div id="mck-write-box" class="blk-lg-12 mck-write-box">
                                <form id="mck-msg-form" class="vertical mck-msg-form">
                                        ...
                                        <ul id="mck-upload-menu-list"
                                            ...
                                            <li><a id="mck-file-up" href="#"
                                                class="mck-file-upload menu-item" title="File &amp; Photos">
                                                    ...
                                                    <img src="{{ voyager_asset('images/applozic/mck-icon-photo.png')}}"
                                                    class="menu-icon" alt="File &amp; Photos"> <span>Files
                                                        &amp; Photos</span>
                                            </a></li>
                                            <li><a id="mck-btn-loc" href="#" class="menu-item"
                                                title="Location"> <img
                                                    src="{{ voyager_asset('images/applozic/mck-icon-marker.png')}}" class="menu-icon"
                                    ...
                                    <a href="#" id="mck-file-up2" type="button"
                                        ...
                                        title="Attach File"> </a>
                                    <a href="#" id="mck-mike-btn" class="mck-mic-btn mck-mike-btn vis" title="Mike"></a>
                                ...
                                <div id="mck-group-create-icon-box"
                                    ...
                                    <span class="mck-overlay-box">
                                        ...
                                        <div id="mck-group-create-icon-loading"
                                            ...
                                            <img src="{{ voyager_asset('images/applozic/mck-loading.gif')}}" />
                    ...
                    <div class="mck-group-icon-sec">
                        ...
                        <div class="mck-text-center">
                            <a id="mck-btn-group-icon-save" href="#" role="link"
                                ...
                                <img src="{{ voyager_asset('images/applozic/mck-icon-save.png')}}" alt="Save">
                            </a>
                        </div>
                    </div>
                        ...
                        <div id="mck-group-name-box" class="mck-row mck-group-name-box">
                            ...
                            <div class="blk-lg-3 mck-group-name-edit-icon">
                                <a id="mck-group-name-edit" href="#" role="link"
                                    ...
                                    src="{{ voyager_asset('images/applozic/mck-icon-write.png')}}" alt="Edit"></a> <a
                                    id="mck-group-name-save" href="#" role="link"
                                    class="mck-group-name-save n-vis" title="Click to save"> <img
                                    src="{{ voyager_asset('images/applozic/mck-icon-save.png')}}" alt="Save"></a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mck-group-md-sec">
                            ...
                            <div id="mck-group-add-member-box"
                                ...
                                <a id="mck-group-add-member" class="mck-group-add-member"
                                    href="#">
                                    <div class="blk-lg-3">
                                        <img src="{{ voyager_asset('images/applozic/mck-icon-add-member.png')}}"
                                            alt="Add Member">
                                    </div>
                ...
                <div class="mck-box-body">
                    <div class="mck-form-group">
                        ...
                        <div id="mck-group-search-input-box"
                            class="mck-input-group blk-lg-12 -vis">
    ...
    <div id="mck-goup-search-box"
        ...
        <div class="mck-box-dialog mck-box-sm">
            <div class="mck-box-content">
                <div class="mck-box-top mck-row">
                    <div class="blk-lg-3">
                        <img src="{{ voyager_asset('images/applozic/mck-icon-add-member.png')}}" alt="Add Member">
                    </div>
                    <div class="blk-lg-7">
...
@section('javascript')
    ...
    <script type="text/javascript" src="{{ voyager_asset('js/applozic/app/call/mck-ringtone-service.js') }}"></script>
    <script type="text/javascript" src="{{ voyager_asset('js/applozic/app/call/twilio-video.js') }}"></script>
    <script type="text/javascript" src="{{ voyager_asset('js/applozic/app/call/videocall.js') }}"></script>
<!-- Video Call dependencies -->
    <script type="text/javascript" src="{{ voyager_asset('js/applozic/applozic.plugins.min.js') }}"></script>
    <script type="text/javascript" src="{{ voyager_asset('js/applozic/applozic.widget.min.js') }}"></script>
    <script type="text/javascript" src="{{ voyager_asset('js/applozic/applozic.emojis.min.js') }}"></script>
    <script type="text/javascript" src="{{ voyager_asset('js/applozic/applozic.socket.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ voyager_asset('js/applozic/locationpicker.jquery.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ voyager_asset('js/applozic/app/applozic.common.js') }}"></script>
    <script type="text/javascript"
        src="{{ voyager_asset('js/applozic/app/fullview/applozic.fullview.js') }}"></script>
    ...
    <script src="{{ voyager_asset('js/applozic/Media/recorder.js') }}"></script>
    <script src="{{ voyager_asset('js/applozic/Media/Fr.voice.js') }}"></script>
    <script src="{{ voyager_asset('js/applozic/Media/mediaapp.js') }}"></script>
    <script type="text/javascript">
        ...
        /*        function initAutoSuggestions() {
         ...
         data: autoSuggest.queries
         }).atwho({
         at: "@templates",
         insertTpl: '${content}',
         displayTpl: '<li>${name} <small>${content}</small></li>',
         data: autoSuggest.templates
         }).atwho({
         at: "#templates",
         insertTpl: '${content}',
         displayTpl: '<li>${name} <small>${content}</small></li>',
                        ...
                        function() {
                            ...
                            $applozic.fn
                                    .applozic({
                                        ...
                                        userId : 'admin', //TODO: replace userId with actual UserId
                                        userName : 'Administrator',         //TODO: replace userId with actual UserName
                                        appId : '29d9da79ffdee368152253225c58ab27e',         //TODO: replace appId with your applicationId
